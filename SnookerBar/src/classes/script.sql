...
CREATE TABLE  "COMANDA" 
   (    "cd_comanda" NUMBER(4,0) NOT NULL ENABLE, 
...
CREATE TABLE  "abertura_comanda" 
   (    "cd_abertura_comanda" NUMBER(10,0) NOT NULL ENABLE, 
    "dt_hora_abertura" DATE NOT NULL ENABLE, 
    "dt_hora_fechar" DATE NOT NULL ENABLE, 
...
CREATE TABLE  "USUARIO" 
   (    "CD_USUARIO" NUMBER(10,0) NOT NULL ENABLE, 
    ...
    "NM_SENHA_USUARIO" VARCHAR2(20) NOT NULL ENABLE, 
...
CREATE SEQUENCE   "ABERTURA_COMANDA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 

CREATE SEQUENCE  "ABERTURA_MESA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE;

CREATE SEQUENCE   "ATENDIMENTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 

CREATE SEQUENCE   "COMANDA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 
...
CREATE SEQUENCE   "MESA_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 

CREATE SEQUENCE   "PRODUTO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 

CREATE SEQUENCE   "SERVICO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ; 
...
INSERT INTO USUARIO VALUES (USUARIO_SEQ.NEXTVAL, 'admin', 'admin', 'S');
